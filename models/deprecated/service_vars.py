...
_pathology_list = [
			...
			('acne_sequels_4','Acné y Secuelas Grado 4'),
			('acne_sequels_5','Acné y Secuelas Grado 5'),
			

			#('cyst','Quiste'),
			('cyst_1','Quiste Grado 1'),
			('cyst_2','Quiste Grado 2'),
			('cyst_3','Quiste Grado 3'),
			('cyst_4','Quiste Grado 4'),
			('cyst_5','Quiste Grado 5'),
			...
			('keratosis_4','Queratosis Grado 4'),
			('keratosis_5','Queratosis Grado 5'),	


			('mole_1','Lunar Grado 1'),
			('mole_2','Lunar Grado 2'),
			('mole_3','Lunar Grado 3'),
			('mole_4','Lunar Grado 4'),
			('mole_5','Lunar Grado 5'),

			#('scar','Cicatriz'),			
			('scar_1','Cicatriz Grado 1'),
			('scar_2','Cicatriz Grado 2'),
			('scar_3','Cicatriz Grado 3'),
			('scar_4','Cicatriz Grado 4'),
