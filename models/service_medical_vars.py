...
_med_lep_list = [
		...
		#(	{"zone":"back",	"pathology":"acne"	},		'Espalda - Acne'),	
		#(	{"zone":"back",	"pathology":"stains"	},		'Espalda - Manchas'),	
		#(	{"zone":"face_all",	"pathology":"acne"	},		'Todo Rostro - Acne'),	
		#(	{"zone":"face_all",	"pathology":"stains"	},		'Todo Rostro - Manchas'),		
	]
